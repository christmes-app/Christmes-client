...
class AppColors{
  ...
  static final Color lightBackground = Color(0xFFf1f1f9);
  static final Color darkBackground = Color(0xFF1C1B1E);
  static final Color lightButton = Color(0xFFf1f1f1);
  static final Color darkButton = Color(0xFF2B2B2B);
}